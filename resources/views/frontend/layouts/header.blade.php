					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{ url('logoutmember') }}"><i class="fa fa-lock"></i> Logout</a></li>
								
								@else
								<li><a href=""><i class="fa fa-star"></i> Wishlist</a></li>
								<li><a href="{{ url('/cart/checkout') }}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="{{ url('cart') }}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								<li><a href="{{ url('registermember') }}"><i class="fa fa-lock"></i> Register</a></li>
								<li><a href="{{ url('loginmember') }}"><i class="fa fa-lock"></i> Login</a></li>
								@endif
							</ul>
						</div>
					</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{ url('homeindex') }}" class="active">Home</a></li>
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										@else
										<li><a href="{{ url('loginmember') }}">Login</a></li>
										@endif
                                    </ul>
                                </li> 
