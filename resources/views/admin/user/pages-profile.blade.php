...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{asset('admin/assets/images/users/'.Auth::user()->avatar)}}" class="rounded-circle" width="150" />
                        
                        <h4 class="card-title m-t-10">{{Auth::user()->name}}</h4>
                        <h6 class="card-subtitle">Accoubts Manager A
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="file" accept="image/*" class="form-control form-control-line" value="" name="avatar">
                            </div>
                        </div>
                        <div class="form-group">
                             ...
                             <!--    thuat toan 3 ngoi:
                                a == 1 ? "dungn" : "sai" -->
                                    ...
                                    <option value="{{$value->id}}" 
                                        <?= Auth::user()->country == $value->id ? "selected" : ""  ?>
